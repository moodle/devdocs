...
Here is [the full list of fixed issues in 2.5.9](https://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project+%3D+mdl+AND+resolution+%3D+fixed+AND+fixVersion+in+%28%222.5.9%22%29+ORDER+BY+priority+DESC&runQuery=true&clear=true).
