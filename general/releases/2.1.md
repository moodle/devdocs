...
#### New question engine {/* #new-question-engine */}
...
#### Ability to restore the course contents from Moodle 1.9 backup files {/* #ability-to-restore-the-course-contents-from-moodle-19-backup-files */}
