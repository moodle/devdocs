...
#### [Community hubs](https://docs.moodle.org/dev/Community_hub) {/* #community-hubs */}
...
#### [Repository support](https://docs.moodle.org/en/Repositories) {/* #repository-support */}
...
#### [Portfolio support](https://docs.moodle.org/en/Portfolios) {/* #portfolio-support */}
...
#### [Course completion](https://docs.moodle.org/dev/Course_completion) and prerequisites {/* #course-completion-and-prerequisites */}
...
#### [Conditional activities](https://docs.moodle.org/dev/Conditional_activities) {/* #conditional-activities */}
...
#### [Web services support](https://docs.moodle.org/dev/Web_Services) {/* #web-services-support */}
...
#### [Plagiarism prevention](https://docs.moodle.org/en/Plagiarism_Prevention) {/* #plagiarism-prevention */}

- Moodle supports integration with plagiarism prevention tools such as Turnitin

### Major improvements to existing core features {/* #major-improvements-to-existing-core-features */}

#### [Backup and restore](https://docs.moodle.org/dev/Backup_2.0) {/* #backup-and-restore */}
...
#### [Blocks](https://docs.moodle.org/en/Blocks_2.0) {/* #blocks */}
...
#### [Blogs](https://docs.moodle.org/en/Blogs_2.0) {/* #blogs */}
...
#### [Comments](https://docs.moodle.org/dev/Comments_2.0) {/* #comments */}
...
#### [Enrolment plugins](https://docs.moodle.org/en/Enrolments_2.0) {/* #enrolment-plugins */}
...
#### [File handling](https://docs.moodle.org/en/File_handling_2.0) {/* #file-handling */}
...
#### [Filters 2.0](https://docs.moodle.org/dev/Filters_2.0) {/* #filters-20 */}
...
#### [HTML editor](https://docs.moodle.org/dev/HTML_editor_2.0) {/* #html-editor */}
...
#### [Messaging](https://docs.moodle.org/dev/Messaging_2.0) {/* #messaging */}
...
#### [My Moodle page](https://docs.moodle.org/dev/My_Moodle_2.0) {/* #my-moodle-page */}
...
#### [Navigation](https://docs.moodle.org/dev/Navigation_2.0) {/* #navigation */}
...
#### [Ratings](https://docs.moodle.org/dev/Ratings_2.0) {/* #ratings */}
...
#### [Roles and permissions](https://docs.moodle.org/en/Roles_2.0) {/* #roles-and-permissions */}
...
#### [RSS feeds](https://docs.moodle.org/en/RSS_feeds_2.0) {/* #rss-feeds */}
...
#### [Themes](https://docs.moodle.org/dev/Themes_2.0) {/* #themes */}
...
#### [Translation system](https://docs.moodle.org/dev/Translation_2.0) {/* #translation-system */}
...
### Major improvements to activity modules {/* #major-improvements-to-activity-modules */}
...
#### Quiz module and question bank {/* #quiz-module-and-question-bank */}
...
### For developers: API changes {/* #for-developers-api-changes */}
