...
### Dashboard and Course overview {/* #dashboard-and-course-overview */}
...
### Privacy API update {/* #privacy-api-update */}
...
### Behat scenario files {/* #behat-scenario-files */}
...
### New core functions {/* #new-core-functions */}

- <tt>userdate_htmltime()</tt>

### New callback hooking points in page layouts {/* #new-callback-hooking-points-in-page-layouts */}
...
### Component APIs upgrades {/* #component-apis-upgrades */}
