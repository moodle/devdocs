...
- [MDL-55528](https://tracker.moodle.org/browse/MDL-55528) - New plugin type 'fileconverter' for file conversions, unoconv is now a plugin that can be replaced with scalable commercial solutions (see [File Converters](/docs/apis/plugintypes/fileconverter))
