...
- [MDL-35611](https://tracker.moodle.org/browse/MDL-35611) - [Behat integration](/general/development/tools/behat/), the framework for testing of user expectations, has been incorporated into Moodle.
...
Moodle 2.5 also includes fixes to security issues resolved in earlier minor versions released after [Moodle 2.4](/general/releases/2.4). See the release notes for [Moodle 2.4.1](/general/releases/2.4/2.4.1), [Moodle 2.4.2](/general/releases/2.4/2.4.2) and [Moodle 2.4.3](/general/releases/2.4/2.4.3) for more details.
