...
Here is [the full list of fixed issues in 2.2.4](http://moodle.atlassian.net/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project+%3D+mdl+AND+resolution+%3D+fixed+AND+fixVersion+in+%28%222.2.4%22%29+ORDER+BY+priority+DESC&runQuery=true&clear=true).
...
- [MDL-24401](https://moodle.atlassian.net/browse/MDL-24401) String default changes
...
- [MDL-25695](https://moodle.atlassian.net/browse/MDL-25695) TOC links now work in Wiki
