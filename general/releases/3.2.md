...
- [MDL-50937](https://tracker.moodle.org/browse/MDL-50937) - JQuery updated to version 3.1 (see [jQuery](/docs/guides/javascript/jquery/))
...
- [MDL-55727](https://tracker.moodle.org/browse/MDL-55727) - AMD modal module introduced (see [AMD Modal documentation](/docs/guides/javascript/modal/))
...
- [MDL-48114](https://tracker.moodle.org/browse/MDL-48114) - Moodle can now be downloaded via composer (see [Composer](../development/tools/composer.md#use-composer-to-download-moodle-code))
- [MDL-55091](https://tracker.moodle.org/browse/MDL-55091) - phpunit has been upgraded to 5.x
- [MDL-55072](https://tracker.moodle.org/browse/MDL-55072) - Behat now supports different themes. (See [Running acceptance test](../development/tools/behat/running.md))
