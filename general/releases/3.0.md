...
- [MDL-50783](https://tracker.moodle.org/browse/MDL-50783) - Allow some ajax external functions to be called without a session ([documentation](/docs/guides/javascript/ajax/))
