...
- [`unit_test_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20unit_test_required)<br/>
Used to flag issues that should have their own unit tests.

- [`acceptance_test_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20acceptance_test_required)<br/>
...
- [`qa_test_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20qa_test_required)<br/>
...
- [`qa_identified`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20qa_identified)<br/>
...
- [`docs_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20docs_required)<br/>
...
- `cl_docs_required` ([all](https://moodle.atlassian.net/issues/?jql=labels%20in%20(cl_docs_required)) | [yours](https://moodle.atlassian.net/issues/?jql=labels%20in%20(cl_docs_required)%20AND%20assignee%20%3D%20currentUser()))<br/>
...
- `dev_docs_required` ([all](https://moodle.atlassian.net/issues/?jql=labels%20in%20(dev_docs_required)) | [yours](https://moodle.atlassian.net/issues/?jql=labels%20in%20(dev_docs_required)%20AND%20assignee%20%3D%20currentUser()))<br/>
...
- `security_benefit`<br/>
Used to flag issues which help to improve the security of Moodle, but are not directly exploitable security bugs (and therefore do not have a security level assigned). For example, [MDL-66775](https://moodle.atlassian.net/browse/MDL-66775) and [MDL-65443](https://moodle.atlassian.net/browse/MDL-65443).
...
- [`performance`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20performance%20AND%20project%20%3D%20MDL)<br/>
Used to flag any issues that developers think may affect Moodle's performance in some way (positively or negatively).

- [`ui_change`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20ui_change)<br/>
...
- [`ux_review_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20%22ux_review_required%22)<br/>
...
- [`release_notes`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20release_notes)<br/>
Used to identify all issues to be listed in the release notes (minor or major).

- [`upgrade_notes`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20upgrade_notes)<br/>
...
- [`developer_notes`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20developer_notes)<br/>
...
- [`test_server_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20%20test_server_required)<br/>
Used to identify QA tests which can't be tested on the [QA testing site](http://qa.moodle.net) such as upgrade testing.

- [`credentials_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20credentials_required)<br/>
...
- [`addon_candidate`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20addon_candidate)<br/>
...
Used to identify MDL issues that may affect the mobile app. It should be used when adding new features to functionalities supported by the app or when doing changes in existing ones. Examples are: [MDL-372](https://moodle.atlassian.net/browse/MDL-372) and [MDL-38158](https://moodle.atlassian.net/browse/MDL-38158).
...
- [`ready_for_integration`](https://moodle.atlassian.net/issues/?filter=21824)<br/>
