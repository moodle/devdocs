...
- [`performance`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20performance%20AND%20project%20%3D%20MDL)
...
- [`triaging_in_progress`](https://moodle.atlassian.net/issues/?jql=labels%20in%20(triaging_in_progress))
...
- `cl_docs_required` ([all](https://moodle.atlassian.net/issues/?jql=labels%20in%20(cl_docs_required)) | [yours](https://moodle.atlassian.net/issues/?jql=labels%20in%20(cl_docs_required)%20AND%20assignee%20%3D%20currentUser()))
...
- `dev_docs_required` ([all](https://moodle.atlassian.net/issues/?jql=labels%20in%20(dev_docs_required)) | [yours](https://moodle.atlassian.net/issues/?jql=labels%20in%20(dev_docs_required)%20AND%20assignee%20%3D%20currentUser()))
...
- [`developer_notes`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20developer_notes)
...
- [`docs_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20docs_required)
...
- [`release_notes`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20release_notes)

  Used to identify all issues to be listed in the release notes (minor or major).

- [`upgrade_notes`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20upgrade_notes)
...
- [`credentials_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20credentials_required)
...
- [`test_server_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20%20test_server_required)

  Used to identify QA tests which can't be tested on the [QA testing site](http://qa.moodle.net) such as upgrade testing.

- [`unit_test_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20unit_test_required)
...
- [`ux_review_required`](https://moodle.atlassian.net/issues/?jql=labels%20%3D%20%22ux_review_required%22)
