...
## Will an issue be automatically rejected if CiBot checks fail? {/* #will-an-issue-be-automatically-rejected-if-cibot-checks-fail */}
...
## Should coding style issues in existing code be fixed? {/* #should-coding-style-issues-in-existing-code-be-fixed */}
...
### Example "Should I fix coding style" situations {/* #example-should-i-fix-coding-style-situations */}
...
## Requesting CiBot checks an issue {/* #requesting-cibot-checks-an-issue */}
...
## Are additional CiBot checks possible? {/* #are-additional-cibot-checks-possible */}
...
## How do I report bugs in the CiBot report? {/* #how-do-i-report-bugs-in-the-cibot-report */}
...
## The git commit summary  limit is too small {/* #the-git-commit-summary--limit-is-too-small */}
...
## Branches based off integration.git {/* #branches-based-off-integrationgit */}
...
## Why are issues held up by trivial issues reported which don't affect the functionality of the change? {/* #why-are-issues-held-up-by-trivial-issues-reported-which-dont-affect-the-functionality-of-the-change */}
