...
## Different ways the Moodle mobile app can be installed or accessed {/* #different-ways-the-moodle-mobile-app-can-be-installed-or-accessed */}

### Installation in a mobile device via Google Play or Apple App store {/* #installation-in-a-mobile-device-via-google-play-or-apple-app-store */}
...
### Windows 11 or macOS (Apple silicon) {/* #windows-11-or-macos-apple-silicon */}
...
### Hosted version (aka webapp) {/* #hosted-version-aka-webapp */}
