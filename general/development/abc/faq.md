...
### Where can I download Moodle? {/* #where-can-i-download-moodle */}
...
### Who can I ask for help? {/* #who-can-i-ask-for-help */}
...
### How do I create a module or plugin? {/* #how-do-i-create-a-module-or-plugin */}
...
### Is there any information on backup and restore? {/* #is-there-any-information-on-backup-and-restore */}

Learn how to use Moodle's [backup](/docs/apis/subsystems/backup) and [restore](/docs/apis/subsystems/backup/restore) APIs.

### How can I customise Moodle with my own plugin? {/* #how-can-i-customise-moodle-with-my-own-plugin */}

[Local plugins](/docs/apis/plugintypes/local) are a great way to customise Moodle when no standard plugin fits.

## Moodle's database {/* #moodles-database */}

### Where can I see a schema for the structure of the Moodle database? {/* #where-can-i-see-a-schema-for-the-structure-of-the-moodle-database */}
...
### How do I find out the currently-logged-on user? {/* #how-do-i-find-out-the-currently-logged-on-user */}
...
### How do I find out the current course? {/* #how-do-i-find-out-the-current-course */}
...
### How do I insert/retrieve records in the database? {/* #how-do-i-insertretrieve-records-in-the-database */}
...
### How do I get/set configuration settings? {/* #how-do-i-getset-configuration-settings */}
...
#### config_plugin table {/* #config_plugin-table */}
...
### How do I migrate my Moodle site? {/* #how-do-i-migrate-my-moodle-site */}
