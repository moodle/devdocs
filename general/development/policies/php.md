...
PHP 8.5 support **is currently being implemented** for Moodle 5.3 and later releases. Hence it's still **incomplete and only for development purposes**. See MDL-84684 for details.
