...
:::note lib/amd/src/chartjs-lazy.js
...
:::note lib/editor/atto/plugins/html/yui/src/codemirror
...
:::note filter/mediaplugin/flvplayer.swf
...
:::note /mod/assign/feedback/editpdf/fpdi/
...
:::note admin/tool/policy/amd/src/jquery-eu-cookie-law-popup.js
...
:::note lib/jquery/jquery-migrate-1.4.0.js
...
Not actually included in Moodle. Instead, Moodle [has a setting](https://docs.moodle.org//en/MathJax_filter) for where the library is located to be loaded from. It is currently pointing to the Cloudflare CDN by default.

:::

:::note filter/mathjaxloader/

JavaScript filter library for displaying LaTeX, AsciiMath notation, and MathML.

**Version**: 2.7.9 (Default MathJax in Moodle 4.0)<br/>
**License**: Apache 2.0
...
:::note lib/minify/matthiasmullie-minify
...
:::note lib/minify/matthiasmullie-pathconverter
...
:::note cache/stores/mongodb/MongoDB/
...
:::note lib/phpexcel/PHPExcel.php
...
:::note admin/tool/usertours/amd/src/popper.js
...
:::note lib/editor/atto/yui/src/rangy/js/*.*
...
:::note media/player/videojs/amd/src/video-lazy.js & media/player/videojs/videojs
...
:::note media/player/videojs/amd/src/videojs-ogvjs-lazy.js
