...
- New [[Moodle Mobile simulator]] for easier development
- New support for the Phonegap Developer App: [[Moodle Mobile Testing with Phonegap Developer app]]
- Themes creation documentation: [\[Moodle Mobile Themes\]][Complete list of fixed issues in Moodle Mobile 1.5](https://tracker.moodle.org/issues/?jql=project%20%3D%20MOBILE%20AND%20fixVersion%20%3D%20%221.5%22)
...
We've called it version 1.2 because the feature set is inherited from the deprecated iOS-only app [[Mobile app | "My Moodle"]] which was version 1.1.
