...
### Install a browser for development {/* #install-a-browser-for-development */}
...
### Install native SDKs {/* #install-native-sdks */}
...
### Windows only: Native build dependencies {/* #windows-only-native-build-dependencies */}
...
### Mac only: Push notifications {/* #mac-only-push-notifications */}
...
## Running the app in a browser {/* #running-the-app-in-a-browser */}
...
## Running the app in Android and iOS {/* #running-the-app-in-android-and-ios */}
...
### Developing using Live Reload {/* #developing-using-live-reload */}
...
### Compiling using AOT {/* #compiling-using-aot */}
