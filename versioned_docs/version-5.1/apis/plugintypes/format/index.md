...
## Implementing format specific actions {/* #implementing-format-specific-actions */}
...
### Execute format specific action from the course page via Ajax {/* #execute-format-specific-action-from-the-course-page-via-ajax */}
...
### Execute state actions via non-AJAX requests {/* #execute-state-actions-via-non-ajax-requests */}
