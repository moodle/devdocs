...
## List of differences from normal plugins: {/* #list-of-differences-from-normal-plugins */}
...
### Adding an element to the settings menu {/* #adding-an-element-to-the-settings-menu */}
...
### Removing the "Site Home" link from the navigation menu {/* #removing-the-site-home-link-from-the-navigation-menu */}
...
### Adding Site Wide Settings For Your Local Plugin {/* #adding-site-wide-settings-for-your-local-plugin */}
