...
### lang/en/antivirus_scanmyfile.php {/* #langenantivirus_scanmyfilephp */}
...
### classes/scanner.php {/* #classesscannerphp */}
...
### tests/scanner_test.php (optional) {/* #testsscanner_testphp-optional */}
