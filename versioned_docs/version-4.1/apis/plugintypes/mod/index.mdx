...
### `/lang/en/mod_[modname].php` - Language string definitions {/* #langenmod_modnamephp---language-string-definitions */}
...
- [Module visibility and display](/docs/apis/plugintypes/mod/visibility)
