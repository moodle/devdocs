...
## Difference between user enrolment and role assignment {/* #difference-between-user-enrolment-and-role-assignment */}
...
### What is enrolment? {/* #what-is-enrolment */}
...
### count_enrolled_users() {/* #count_enrolled_users */}
...
### enrol_get_plugin(): enrol_plugin {/* #enrol_get_plugin-enrol_plugin */}
...
## Enrolment plugin methods {/* #enrolment-plugin-methods */}
...
### $enrol_plugin->enrol_user() {/* #enrol_plugin-enrol_user */}
...
### $enrol_plugin->unenrol_user() {/* #enrol_plugin-unenrol_user */}
...
### $enrol_plugin->update_user_enrol() {/* #enrol_plugin-update_user_enrol */}
...
### $enrol_plugin->add_default_instance() {/* #enrol_plugin-add_default_instance */}
...
### $enrol_plugin->add_custom_instance() {/* #enrol_plugin-add_custom_instance */}
...
### $enrol_plugin->delete_instance() {/* #enrol_plugin-delete_instance */}
...
### $enrol_plugin->is_csv_upload_supported() {/* #enrol_plugin-is_csv_upload_supported */}
