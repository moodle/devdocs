...
## When to use locking {/* #when-to-use-locking */}
...
## Use a different lock type from the default {/* #use-a-different-lock-type-from-the-default */}
...
## Implementing new lock types {/* #implementing-new-lock-types */}
