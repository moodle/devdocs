...
## Writing a new React component {/* #writing-a-new-react-component */}
...
## Mounting programmatically {/* #mounting-programmatically */}
...
## Console output in dev mode {/* #console-output-in-dev-mode */}
