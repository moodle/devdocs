...
### React build is integrated into Grunt {/* #react-build-is-integrated-into-grunt */}
...
### Context-aware `grunt` from React source directories {/* #context-aware-grunt-from-react-source-directories */}
...
### Watch mode uses esbuild native context {/* #watch-mode-uses-esbuild-native-context */}
...
### Cross-component alias generation is automatic {/* #cross-component-alias-generation-is-automatic */}
...
#### What `tsconfig.aliases.json` is for {/* #what-tsconfigaliasesjson-is-for */}
...
### External packages are excluded from bundles {/* #external-packages-are-excluded-from-bundles */}
...
## Commands for developers {/* #commands-for-developers */}
