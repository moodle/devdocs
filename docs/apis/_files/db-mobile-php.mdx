...
See the [Moodle App Plugins Development Guide](../../guides/moodleapp/development/plugins-development-guide) for more information on configuring your plugin for the Moodle MobileApp.
