...
See the [Moodle App Plugins development guide](../../moodleapp/development/plugins-development-guide/index.md) for more information on configuring your plugin for the Moodle App.
