...
The identifier passed to the attribute must start with a lowercase letter, and may otherwise only contain lowercase letters, numbers, and underscores. It must **not** contain a colon (`:`) or the component name -- both of these are added automatically.
