...
## Most-used General API {/* #most-used-general-api */}

These APIs are critical and will be used by nearly every Moodle plugin.

### Access API (access) {/* #access-api-access */}
...
### Navigation API (navigation) {/* #navigation-api-navigation */}
...
### Output API (output) {/* #output-api-output */}
...
### Upgrade API (upgrade) {/* #upgrade-api-upgrade */}
...
### Moodlelib API (core) {/* #moodlelib-api-core */}
...
## Other General API {/* #other-general-api */}

### Admin settings API (admin) {/* #admin-settings-api-admin */}
...
### Admin presets API (adminpresets) {/* #admin-presets-api-adminpresets */}
...
### Availability API (availability) {/* #availability-api-availability */}
...
### Communication API (communication) {/* #communication-api-communication */}
...
### Competency API (competency) {/* #competency-api-competency */}
...
### Data definition API (ddl) {/* #data-definition-api-ddl */}
...
### Enrolment API (enrol) {/* #enrolment-api-enrol */}
...
### Experience API (xAPI) {/* #experience-api-xapi */}
...
### External functions API (external) {/* #external-functions-api-external */}
...
### Media API (media) {/* #media-api-media */}
...
### Privacy API (privacy) {/* #privacy-api-privacy */}
...
### Rating API (rating) {/* #rating-api-rating */}
...
### User-related APIs (user) {/* #user-related-apis-user */}
...
### Web services API (webservice) {/* #web-services-api-webservice */}
...
### Badges API (badges) {/* #badges-api-badges */}
...
### Custom fields API (customfield) {/* #custom-fields-api-customfield */}
...
### Advanced grading API (grading) {/* #advanced-grading-api-grading */}
...
### Conditional activities API (condition) - deprecated in 2.7 {/* #conditional-activities-api-condition---deprecated-in-27 */}
...
### Gradebook API (grade) {/* #gradebook-api-grade */}
...
### Plagiarism API (plagiarism) {/* #plagiarism-api-plagiarism */}
...
### Question API (question) {/* #question-api-question */}
