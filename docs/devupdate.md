...
If choosing to use these new methods you **must** use Dependency Injection, or where not available the `\core\di` container, to instantiate the `\core\formatting` class to access them.
