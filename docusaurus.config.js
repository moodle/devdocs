    ...
    plugins: [
        ...
        [
            '@docusaurus/plugin-content-docs',
            {
                ...
                // The Marketplace API reference (see docusaurus-plugin-openapi-docs
                // below) is generated into this instance, so it needs the ApiItem
                // component from docusaurus-theme-openapi-docs to render its pages.
                // ApiItem falls back to the regular DocItem for non-API docs.
                docItemComponent: '@theme/ApiItem',
            },
        ],

        // docusaurus-plugin-openapi-docs: generates reference docs for the Moodle
        // Marketplace API from its OpenAPI spec, straight into the 'general' docs
        // instance so they're picked up by the existing 'community' autogenerated
        // sidebar like any other doc. The generated MDX relies on the components
        // provided by docusaurus-theme-openapi-docs (registered in `themes`
        // above), and the 'general' instance uses `docItemComponent:
        // '@theme/ApiItem'` to render them.
        // The spec is downloaded and prepared for the target environment by
        // scripts/marketplace-openapi.mjs. Regenerate everything with: yarn openapi
        [
            'docusaurus-plugin-openapi-docs',
            {
                ...
                config: {
                    marketplace: {
                        specPath: '.openapi/marketplace.json',
                        outputDir: 'general/community/plugincontribution/marketplace-api',
                        sidebarOptions: {
                            groupPathsBy: 'tag',
                        },
                    },
